        ...
        <div className="flex items-center justify-between p-6">
          ...
          <button 
            ...
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              console.log('New Project clicked from Projects page!');
      ...
      <div className="mx-4 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            <div key={project.id} className="tech-card p-6 group hover:scale-[1.02] transition-all duration-300 flex flex-col h-[400px]">
              {/* Project Header */}
              ...
              <div className="space-y-3 flex-grow">
                ...
                {/* Collaborators - Fixed height container */}
